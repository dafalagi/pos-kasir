        ...
        <table id="zero-config" class="table table-hover" style="width:100%">
            ...
            ?>
                <tr>
                    ...
                    <form method=POST>
                      <input type="hidden" name="id_toko" value="<?php echo $id_kategori; ?>"></input>
                          ...
                          <div class="modal-body">
                            <form class="mt-0" method="POST">
                              <div class="form-group">
                                <input type="hidden" name="id_toko_lama"value="<?php echo $id_kategori; ?>">
                                <input type="text" name="id_toko_baru" class="form-control mb-2" maxlength = "10" size = "10" value="<?php echo $id_kategori; ?>" placeholder="<?php echo $id_kategori; ?>" required></input>
                              </div>
                              <div class="form-group">
                                <input type="text" name="nama_toko" class="form-control mb-2" maxlength = "30" size = "30" value="<?php echo $id_kategori; ?>" placeholder="<?php echo $id_kategori; ?>" required></input>
                              </div>
                              <div class="form-group">
                                <textarea type="text" name="alamat_toko" class="form-control mb-2" maxlength = "50" size = "50" value="<?php echo $id_kategori; ?>" placeholder="<?php echo $id_kategori; ?>" required></textarea>
                              </div>
                              <div class="form-group">
                                <input type="text" name="telp" class="form-control mb-2" maxlength = "15" size = "15" value="<?php echo $id_kategori; ?>" placeholder="<?php echo $id_kategori; ?>" required></input>
                              </div>
                              <div class="form-group">
                              <input type="text" name="nama_pemilik" class="form-control mb-4" maxlength = "50" size = "50" id="" placeholder="Nomor telepon pegawai"></input>
                              </div>
