...
if(isset($_POST['hapus_kategori'])){
  ...
  $sql = "DELETE FROM kategori_produk
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <form method=POST>
                                              ...
                                              <button type="submit" name="hapus_kategori" class="btn btn-dark mb-2 mr-2 rounded-circle" onclick="return confirm('Are you sure you want to do that?');">
